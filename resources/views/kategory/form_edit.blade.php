@extends('layouts.app')
@section('title','Form Edit Kategory')
@section('content_header')
    <h1>Form Edit Kategory</h1> 
@stop
@section('content')
@foreach($data as $rs)
<!-- Horizontal Form -->
...
<div class="col-md-15">
    <div class="card card-info">
        <div class="card-header">
                <h3 class="card-title">Kategory Edit Form</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="{{route('kategory.update',$rs->id)}}" method="POST">
                        @csrf
                    <div class="card-body">
